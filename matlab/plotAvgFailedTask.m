function [] = plotAvgFailedTask(baseDir, folderNum, baseFileName, withError)

    if (!withError) 
      plotFailedTask(1, 3, 2, 'Failed Tasks (%)', 'ALL_APPS', 'percentage_for_all', withError, baseDir, folderNum, strcat(baseFileName, 'Failed_Tasks_Mix'));
    end
